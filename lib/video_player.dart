...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<PlayerTracks?> _getTracks() async {
    if (_isDisposedOrNotInitialized) {
      return null;
    }
  ...
  Future<void> _setTrack(
    ...
    return await _videoPlayerPlatform.setTrack(
      _textureId,
      groupIndex,
      formatIndex,
    );
  ...
  /// The position in the current subtitle text.
  Future<String?> get currentSubtitleText async {
    if (_isDisposed) {
      return null;
    }
    return _videoPlayerPlatform.getCurrentSubtitle(_textureId);
  }
  ...
  /// Gets list of audio tracks of [this].
  Future<PlayerTracks?> getTracks() async {
    return (await _getTracks());
  }
  ...
  Future<void> setTrack({
    ...
    return (await _setTrack(groupIndex, formatIndex));
  }
  ...
  Widget build(BuildContext context) {
    return _textureId == VideoPlayerController.kUninitializedTextureId
        ...
        : _VideoPlayerWithRotation(
            ...
            child: _videoPlayerPlatform.buildView(
              _textureId,

...
class FakeController extends ValueNotifier<VideoPlayerValue>
  ...
  Future<PlayerTracks> getTracks() async {
    return PlayerTracks(groups: []);
  }

  @override
  Future<void> setTrack(
      {required int groupIndex, required int formatIndex}) async {}

  @override
  // TODO: implement currentSubtitleText
  Future<String?> get currentSubtitleText async => null;
}
